...
var prefix = "ub!!";
client.login("NDUwNDQ5NDMzMzQ0MzQ0MDY0.DmAJtg.m_l65ju_L5QyhiHV5CdvxdD06bs");
...
client.on("guildMemberAdd", member => {
  member.guild.channels.find("name", "general").send(`Bienvenue${member} sur le serveur`)
})

client.on("guildMemberRemove", member => {
  member.guild.channels.find("name", "general").send(`${member} vien de quitter le serveur bonne continuation`)
})
...
client.on(`message`, message => {
    ...
    if(message.content === prefix + "help"){
        ...
        .addField(":package:package.help", "Affiche l'aide pour le bienvenue/aurevoir et autorole")
    ...
    if(message.content === prefix + "package.help"){
      ...
      .setThumbnail(message.author.avatarURL)
      .addField("Si vous voulez le bienvenue et l'aurevoir du bot svp", "créer un salon et renomé le general")
      .addField("Si vous voulez un autorole automatique svp", "créer un nouveau role et renomé le membres")
