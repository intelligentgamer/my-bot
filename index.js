    ...
    if (message.member.hasPermission('MANAGE_GUILD')){
      ...
      if (!message.content.startsWith(prefix)) return;
        ...
        if (!args[1]) {
          ...
          message.channel.sendMessage("Tu dois me donner un lien YouTube de ton choix");
        ...
        if(!message.member.voiceChannel) {
          ...
          message.channel.sendMessage(":x: Tu dois être dans un salon vocal, sinon je pourrais pas jouer ta music");
        ...
        if(!message.member.voiceChannel) {
          ...
          message.channel.sendMessage(":x: Mon ami tu dois être dans un salon vocal pour que je puisse jouer ta music");
      ...
      case "stop":
        ...
        return message.channel.send(":x: Mon ami tu dois être dans un salon vocal pour que je puisse arreter la music");
