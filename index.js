...
var prefix = "ub!!";
client.login("NDUwNDQ5NDMzMzQ0MzQ0MDY0.DlM-Dw.lAl1h6Et9Oe6B49UHczDJS9Oua0");
...
client.on(`message`, message => {
    ...
    if(message.content === prefix + "moderation"){
      var help_embed = new Discord.RichEmbed()
      .setColor("RANDOM")
      .setTitle("Voici mes commandes :tools:moderation")
      .setThumbnail(message.author.avatarURL)
    ...
    if(message.content === prefix + "utilitaires"){
      var help_embed = new Discord.RichEmbed()
      .setColor("RANDOM")
    ...
    if(message.content === prefix + "vcs.help"){
      ...
      .setThumbnail(message.author.avatarURL)
      .addField("Vous devez creer un salon est renomé le (vcs-ultrabot) dans ce salon vous devriez faire la commande ub!!vcs(votre message) pour que le message soit envoyé dans tous les serv discord que le bot est present")
